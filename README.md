...
2. SQL scripts are not tracked in this repo. Request the latest schema/migration bundle from the maintainer.
3. Apply the schema/migrations to create tables, policies, functions, and triggers.
